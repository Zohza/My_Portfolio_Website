  ...
  return (
    <section id="certifications" className="relative py-16 md:py-24 lg:py-28 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        {/* Section accent glow */}
        <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-cyan-400/8 blur-[140px] rounded-full pointer-events-none flex justify-center items-center " />
        <div className="flex flex-col md:flex-row md:items-end justify-center items-center gap-6 mb-12 ">
